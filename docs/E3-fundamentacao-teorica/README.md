# Entrega E3 — Fundamentação Teórica
...
Esta entrega apresenta o Capítulo 2 — Fundamentação Teórica do Projeto Final, abordando os conceitos e referências relacionados ao projeto, incluindo educação financeira e tomada de decisão, gamificação, serious games, narrativa interativa e trabalhos correlatos.
...
- `README.md` — identificação e organização da Entrega E3.
- Documento do Projeto Final — versão correspondente à Entrega E3.
...
- **Por quê:** {{breve justificativa sobre a fundamentação teórica desenvolvida.}}
