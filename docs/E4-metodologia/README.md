...
Esta entrega apresenta o Capítulo 3 — Metodologia do Projeto Final, descrevendo os procedimentos, métodos, ferramentas e tecnologias utilizados no desenvolvimento do sistema.
...
- `README.md` — identificação e organização da Entrega E4.
- Documento do Projeto Final — versão correspondente à Entrega E4.
